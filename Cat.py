...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep 17 16:46:31 2021
...
def clew(center_x, center_y, scale, flip = False):
    ...
    new_clew_surface = pygame.transform.scale(
    clew_surface, (clew_surface.get_width() // scale,
               clew_surface.get_height() // scale))
